...
--
-- Table structure for table `cart_xx`
--

DROP TABLE IF EXISTS `cart_xx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `cart_xx` (
  `id` int(11) NOT NULL,
  ...
  KEY `fk1_idx` (`uid`),
  KEY `fk2_idx` (`cid`),
  CONSTRAINT `key1` FOREIGN KEY (`cid`) REFERENCES `clothing_xx` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `key2` FOREIGN KEY (`uid`) REFERENCES `user_xx` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cart_xx`
--

LOCK TABLES `cart_xx` WRITE;
/*!40000 ALTER TABLE `cart_xx` DISABLE KEYS */;
INSERT INTO `cart_xx` VALUES (1,6,6,1),(2,6,16,2),(3,6,21,1),(4,6,30,2),(5,6,36,2);
/*!40000 ALTER TABLE `cart_xx` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `category_xx` VALUES (1,'hats',NULL,'https://i.ibb.co/cvpntL1/hats.png','/img/homepage/hats.png','/crown2_xx/shop2_xx/hats'),(2,'jackets',NULL,'https://i.ibb.co/px2tCc3/jackets.png','/img/homepage/jackets.png','/crown2_xx/shop2_xx/jackets'),(3,'sneakers',NULL,'https://i.ibb.co/0jqHpnp/sneakers.png','/img/homepage/sneakers.png','/crown2_xx/shop2_xx/sneakers'),(4,'womens','large','https://i.ibb.co/GCCdy8t/womens.png','/img/homepage/womens.png','/crown2_xx/shop2_xx/womens'),(5,'mens','large','https://i.ibb.co/R70vBrQ/men.png','/img/homepage/mens.png','/crown2_xx/shop2_xx/mens');
...
INSERT INTO `user_xx` VALUES (1,'John Doe','jdoe@gmail.com','123456789'),(2,'Harry White','harry@yahoo.com','789456123'),(3,'Mary Johnson','mary@gmail.com','abcdefg123'),(4,'Robert','robert@gmail.com','123456'),(5,'Mary Smith','marysmith@gmail.com','msmith'),(6,'u123456789','123456789@mail.tku.edu.tw','123456');
...
-- Dump completed on 2021-01-04 17:26:39
